<?php $__env->startSection("title"); ?> CANDLER-База для свічок <?php $__env->stopSection(); ?>
<?php $__env->startSection("content_part"); ?>
    <div class="main_part">
        <div class="content_m">
            <div class="navigator">
                <a class="navigation" href="/"> >>Головна сторінка</a>
                <a class="navigation" href="/catalog">>>База для січок</a>
            </div>
            <div class="main_cont">
                <div class="left_menu">
                    <div class="catalog">
                ...
                <div class="articls">
                    ...
                    <div class="item_list">
                        <div class="stuff">
                            ...
                            <a class="name_stuff" href="/parafin" id="link">
                                Парафін П-2
                            </a>
                            <div >
                                <div class=" mark ">
...
<?php echo $__env->make("layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\lab5\resources\views/catalog.blade.php ENDPATH**/ ?>